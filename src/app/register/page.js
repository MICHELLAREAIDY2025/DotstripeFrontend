...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-b from-[#031626] to-[#0E4459]">
      <ToastContainer
        position="top-right"
        autoClose={5000}
      ...
      <div className="flex flex-1 flex-col justify-center items-center">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            <Link
              href="/"
              className="inline-flex items-center text-white bg-[#18608C] hover:bg-[#17A0BF] transition-colors py-2 px-4 rounded-lg shadow-md font-medium w-full sm:w-auto justify-center sm:justify-start"
            >
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            {error && (
              <div className="bg-red-50 border-l-4 border-red-500 p-3 mb-6 rounded-r-md animate-shake text-sm">
      ...
      {/* Right side - Image and text for large screens */}
      <div className="relative hidden lg:block w-1/2">
        ...
        <div className="absolute inset-0 z-20 p-12 flex flex-col justify-between">
          ...
          <div className="max-w-md mx-auto text-center">
            <h1 className="text-4xl font-bold text-white mb-6">Join Dot stripe</h1>
