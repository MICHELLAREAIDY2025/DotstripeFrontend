  ...
  return (
    <div className="min-h-screen bg-[#031626] flex flex-col">
      ...
      <main className="flex-1">
        <div
          className={`container mx-auto px-4 pt-32 md:pt-36 pb-12 transition-all duration-700 ease-out ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          {/* Hero Section */}
          <div className="text-center mb-16">
            <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center text-white">Our Services</h1>
            <h2 className="text-2xl md:text-3xl font-bold text-white">Providing Truly Professional IT Solutions</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {services.map((service) => (
              <div key={service.id} className="flex flex-col items-center">
                ...
                {/* Service Name */}
                <h3 className="text-white text-xl font-semibold mb-2 text-center">{service.name}</h3>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mb-16">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Discover Our Latest Products</h2>
              <p className="text-gray-300 mb-8">
                Explore our wide range of cutting-edge technology products and solutions tailored to meet your business
                needs.
              </p>
              <Link
