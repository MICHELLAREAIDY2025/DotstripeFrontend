...
export default function ProductsPage() {
  ...
  const filteredProducts =
    selectedCategory === "all" ? products : products?.filter((product) => product.category?.name === selectedCategory)
    ...
    <div className="min-h-screen bg-[#031626] flex flex-col">
      ...
      <main className="flex-1 pt-32 md:pt-36 pb-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Our Products</h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button
                ...
                className={`px-6 py-2 rounded-full transition-all duration-300 ${
                  selectedCategory === "all" ? "bg-[#18608C] text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                }`}
              >
                All Products
              </button>
            ...
            <div className="flex justify-center items-center space-x-2 mt-8">
              <button
                ...
                className={`px-4 py-2 rounded-md ${
                  currentPage === 1 ? "bg-gray-300 cursor-not-allowed" : "bg-[#18608C] text-white hover:bg-[#17A0BF]"
                }`}
              >
                Previous
              </button>
          ...
          <div className="text-center mt-16 mb-8">
            <div className="max-w-2xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Explore Our Professional Services</h2>
              <p className="text-gray-300 mb-8">
                Discover our comprehensive range of IT services designed to help your business grow and succeed.
              </p>
              <Link
              ...
              >
                <span className="text-lg font-semibold">View Our Services</span>
                <svg
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    ...
                    <div className="flex justify-between items-center mb-4">
                      <span className="text-[#18608C] font-bold text-2xl">${selectedProduct.price}</span>
                      {modalMode === "cart" && (
